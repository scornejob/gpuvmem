...
hco23:
	@ clear
	@ ./bin/mem.run -i ./tests/HCO-chan23/HCO-23.sqlite -o ./tests/HCO-chan23/HCO-23_out.sqlite -m ./tests/HCO-chan23/mod_in_0.fits -b ./tests/HCO-chan23/beam_0.fits -d ./tests/HCO-chan23/input.dat -p ./tests/HCO-chan23/mem/

freq78:
	@ clear
	@ ./bin/mem.run -i ./tests/FREQ78/FREQ78.sqlite -o ./tests/FREQ78/FREQ78_out.sqlite -m ./tests/FREQ78/mod_in_0.fits -b ./tests/FREQ78/beam_0.fits -d ./tests/FREQ78/input.dat -p ./tests/FREQ78/mem/

phantom:
	@ clear
	@ ./bin/mem.run -i ./tests/phantom/phantom.sql -o ./tests/phantom/phantom_out.sql -m ./tests/phantom/mod_in_0.fits -b ./tests/phantom/beam_0.fits -d ./tests/phantom/input.dat -p ./tests/phantom/mem/
